...
export function Chapter5() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-50 to-rose-50" id="capitulo-5-sono-tranquilo">
      {/* Header */}
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-lg font-semibold text-gray-900">Capítulo 5 — Sono Tranquilo</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card className="shadow-lg">
          <CardHeader className="text-center pb-6">
            ...
            <CardTitle className="text-3xl font-bold text-gray-900 mb-2">Capítulo 5 — Sono Tranquilo</CardTitle>
